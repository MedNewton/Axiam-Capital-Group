...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"node_modules/gsap-trial/SplitText.js":[function(require,module,exports) {
"use strict";
...
let u,
  ...
  _ = (D, e, t, F, C, i, n) => {
    let s,
      ...
      O = b("fontSize", S) * (e.lineThreshold || .2),
      H = S.textAlign,
      V = [],
      R = [],
      j = [],
    ...
    for (s = 0; s < l; s++) if (o = r[s], d = o.parentNode === D, "BR" !== o.nodeName) {
      if (G && (A = o.style, $ || d || (o._x += o.parentNode._x, o._y += o.parentNode._y), A.left = o._x + "px", A.top = o._y + "px", A.position = "absolute", A.display = "block", A.width = o._w + 1 + "px", A.height = o._h + "px"), !$ && q) {
        if (o._isSplit) for (o._next = E = o.nextSibling, o.parentNode.appendChild(o); E && 3 === E.nodeType && " " === E.textContent;) o._next = E.nextSibling, o.parentNode.appendChild(E), E = E.nextSibling;else o.parentNode._isSplit ? (o._parent = o.parentNode, !o.previousSibling && o.firstChild && (o.firstChild._isFirst = !0), o.nextSibling && " " === o.nextSibling.textContent && !o.nextSibling.nextSibling && K.push(o.nextSibling), o._next = o.nextSibling && o.nextSibling._isFirst ? null : o.nextSibling, o.parentNode.removeChild(o), r.splice(s--, 1), l--) : d || (w = !o.nextSibling && x(o.parentNode, D, M), o.parentNode._parent && o.parentNode._parent.appendChild(o), w && o.parentNode.appendChild(u.createTextNode(" ")), "span" === k && (o.style.display = "inline"), V.push(o));
...
var _SplitText = _interopRequireDefault(require("gsap-trial/SplitText"));
  ...
  return _createClass(TextAnimations, [{
    ...
    value: function animateHeroText() {
      ...
      titles1.forEach(function (title) {
        var splitTitle = new _SplitText.default(title);
      ...
      dots.forEach(function (dot) {
        var splitDot = new _SplitText.default(dot);
    ...
    value: function animateMenu() {
      ...
      var toggleMenuBtnLine1 = document.querySelector(".bar1");
      var toggleMenuBtnLine2 = document.querySelector(".bar2");
      var toggleMenuBtnLine3 = document.querySelector(".bar3");
      var isToggled = false;
      burgerBtn.addEventListener('click', function () {
        if (isToggled === false) {
          isToggled = true;
          alert(isToggled);
          _gsap.default.to(toggleMenuBtnLine2, {
            duration: 0.2,
            width: "0px",
            ease: "power2.inOut"
          });
...
new TextAnimations();
},{"gsap":"node_modules/gsap/index.js","gsap-trial/SplitText":"node_modules/gsap-trial/SplitText.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
