    ...
    let me,
      ...
      qe = Te.onRelease = t => {
        ...
        !o && r && (Te._vx.reset(), Te._vy.reset(), w && ge && e.delayedCall(.08, () => {
          if (x() - Ie > 300 && !t.defaultPrevented) if (t.target.click) t.target.click();else if (De.createEvent) {
...
let X,
  ...
  Lt = (e, t, r, i, s, o, a, n, l, c, d, p, h, g) => {
    ...
    let u,
      ...
      m,
      v = h ? h.time() : 0;
    if (h && h.seek(0), isNaN(e) || (e = +e), We(e)) h && (e = X.utils.mapRange(h.scrollTrigger.start, h.scrollTrigger.end, 0, p, e)), a && dt(a, r, i, !0);else {
      Fe(t) && (t = t(n));
      let o,
        d,
        p,
  ...
  init(e, t) {
    ...
    if (Et._startClamp = Et._endClamp = !1, Et._dir = gt, Pe *= 45, Et.scroller = vt, Et.scroll = st ? st.time.bind(st) : Wt, o = Wt(), Et.vars = e, t = t || e.animation, "refreshPriority" in e && (re = 1, -9999 === e.refreshPriority && (be = Et)), yt.tweenScroll = yt.tweenScroll || {
      ...
      let e = Wt(),
        i = _e() - Bt < 500,
        o = r.tween;
      if (!(i || Math.abs(Et.getVelocity()) < 10) || o || Z || Dt === e) Et.isActive && Dt !== e && ee.restart(!0);else {
        let a,
          c,
          d = (e - n) / f,
    ...
    if (Et.previous = () => pt[pt.indexOf(Et) - 1], Et.next = () => pt[pt.indexOf(Et) + 1], Et.revert = (e, r) => {
      ...
      i !== Et.isReverted && (i && (te = Math.max(Wt(), Et.scroll.rec || 0), Nt = Et.progress, se = t && t.progress()), c && [c, d, p, h].forEach(e => e.style.display = i ? "none" : "block"), i && (K = Et, Et.update(i)), !ue || Le && Et.isActive || (i ? ((e, t, r) => {
        It(r);
        let i = e._gsap;
        if (i.spacerIsNative) It(i.spacerState);else if (e._gsap.swappedIn) {
          let r = t.parentNode;
      ...
      if (i && (a = o, o = st ? Wt() : w, Ye && (q = H, H = t && !ft ? t.totalProgress() : k)), Pe && ue && !K && !we && ke && (!k && n < w + (w - a) / (_e() - G) * Pe ? k = 1e-4 : 1 === k && l > w + (w - a) / (_e() - G) * Pe && (k = .9999)), k !== E && Et.enabled) {
        if (c = Et.isActive = !!k && k < 1, d = !!E && E < 1, m = c !== d, u = m || !!k != !!E, Et.direction = k > E ? 1 : -1, Et.progress = k, u && !K && (h = k && !E ? 0 : 1 === k ? 1 : 1 === E ? 2 : 3, ft && (g = !m && "none" !== Tt[h + 1] && Tt[h + 1] || Tt[h], y = t && ("complete" === g || "reset" === g || g in t))), dt && (m || y) && (y || he || !t) && (Fe(dt) ? dt(Et) : Et.getTrailing(dt).forEach(e => e.endAnimation())), ft || (!j || K || we ? t && t.totalProgress(k, !(!K || !Bt && !e)) : (j._dp._time - j._start !== j._time && j.render(j._dp._time - j._start), j.resetTo ? j.resetTo("totalProgress", k, t._tTime / t._tDur) : (j.vars.totalProgress = k, j.invalidate().restart()))), ue) if (e && ve && (_.style[ve + gt.os2] = R), wt) {
          if (u) {
            if (v = !e && k > E && l + 1 > w && w + 1 >= ze(vt, gt), Le) if (e || !c && !v) Ft(ue, _);else {
              let e = $e(ue, !0),
                t = w - n;
...
let Vt,
  Gt = (e, t, r, i) => (t > i ? e(i) : t < 0 && e(0), r > i ? (i - t) / (r - t) : r < 0 ? t / (t - r) : 1),
  jt = (e, t) => {
...
var _default = exports.default = Ut;
...
var _ScrollTrigger = _interopRequireDefault(require("gsap-trial/ScrollTrigger"));
...
var MenuAnimations = /*#__PURE__*/function () {
  ...
  return _createClass(MenuAnimations, [{
    ...
    value: function animateMenu() {
      ...
      // Mobile : 
      var mobileBurgerBtn = document.querySelector("#mobileBurgerBtn");
      var mobileBurgerBar1 = document.querySelector('.mobileBar1');
      var mobileBurgerBar2 = document.querySelector('.mobileBar2');
      var mobileBurgerBar3 = document.querySelector('.mobileBar3');
      var mobileMenuContainer = document.querySelector('.mobileNavMenu');
      var mobileMenuItems = _gsap.default.utils.toArray(".mobileNavMenuItem");
      var isMobileToggles = false;
      ...
      mobileBurgerBtn.addEventListener('click', function () {
        if (isMobileToggles === false) {
          ...
          _gsap.default.to(mobileBurgerBar2, {
            duration: 0.2,
            width: "0px",
            ease: "power2.inOut"
          });
          _gsap.default.to(mobileBurgerBar1, {
            duration: 0.2,
            rotate: 45,
            transform: "translate(0, 10px)",
            ease: "power2.inOut"
          });
          _gsap.default.to(mobileBurgerBar3, {
            duration: 0.2,
            rotate: -45,
            transform: "translate(0, -10px)",
            ease: "power2.inOut"
          });
          _gsap.default.to(mobileMenuContainer, _defineProperty(_defineProperty({
            duration: 0.3,
            height: "auto",
            zIndex: 9999,
            paddingBottom: 10
          ...
          _gsap.default.to(mobileMenuContainer, _defineProperty({
            duration: 0.3,
            height: "0px",
            ease: "power2.inOut",
            paddingBottom: 0
      ...
      desktopMenuItems.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          var targetSection = "#" + item.id.split("-")[0].toString();
...
new MenuAnimations();
},{"gsap":"node_modules/gsap/index.js","split-text-js":"node_modules/split-text-js/SplitTextJS.js","gsap-trial/ScrollTrigger":"node_modules/gsap-trial/ScrollTrigger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
